...
void save_config_to_file(void)
{
  ...
  update_keyval("tools", "btn2_tool",
    _(" button 2 tool (pen, eraser, highlighter, text, selectregion, selectrect, vertspace, hand)"),
  ...
  update_keyval("tools", "btn3_tool",
    _(" button 3 tool (pen, eraser, highlighter, text, selectregion, selectrect, vertspace, hand)"),
